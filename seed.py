...
SOURCES = [
    ...
    ("USGS WBD", "USGS", "Watershed Boundary Dataset", "https://www.usgs.gov/national-hydrography/watershed-boundary-dataset", "bulk-download", ""),
    ("USGS 3DHP", "USGS", "3D Hydrography Program", "https://www.usgs.gov/3d-hydrography-program", "bulk-download", ""),
